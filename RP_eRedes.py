    ...
    for db in dblist:
        ...
        if status == "ok":
            ...
            # MongoDB
                ...
                CHUNK_SIZE = 60000  # ajustável (500–5000 normalmente funciona bem)
    ...
    for db in dblist:
        ...
        if verbose:
            ...
            if dbcreds['dbms']=="sql_tls":
                ...
                db_stats[db]["size_mb"] = round(size_mb, 2)
            ...
            #MongoDB
                ...
                stats = database.command("collStats", table_name)
                db_stats[db]["size_mb"] = round(
